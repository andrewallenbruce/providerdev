...
htmltools::tagList(
  btn_link(
    "https://andrewallenbruce.github.io/provider/reference/quality_eligibility.html", 
    "Documentation"
    ),
  btn_link(
    "https://github.com/andrewallenbruce/provider/blob/main/R/quality_eligibility.R", 
    "Source"
    ))
```
