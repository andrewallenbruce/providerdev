...
```{r}
providertwo::public_dataset()
providertwo::enrollapi()
providertwo::enrollees(enid = "I20040309000221")
providertwo::enrollees(npi = "1417918293", spec_code = "14-41")
providertwo::enrollees(pac = "2860305554", gender = "9")
```
